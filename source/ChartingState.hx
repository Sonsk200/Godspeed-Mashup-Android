...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var vocals:FlxSound;
	var supervocals:FlxSound;
	var kaiovocals:FlxSound;
	var godvocals:FlxSound;
	var blastervocals:FlxSound;
	...
	function addSongUI():Void
	{
		...
		var check_mute_vocals = new FlxUICheckBox(10, 255, null, null, "Mute Vocals", 100);
		...
		var check_mute_supervocals = new FlxUICheckBox(10, 310, null, null, "Mute Super Vocals", 100);
		check_mute_supervocals.checked = false;
		check_mute_supervocals.callback = function()
		{
			var vol:Float = 1;

			if (check_mute_supervocals.checked)
				vol = 0;

			supervocals.volume = vol;
		};

		var check_mute_kaiovocals = new FlxUICheckBox(10, 365, null, null, "Mute Kaio Vocals", 100);
		check_mute_kaiovocals.checked = false;
		check_mute_kaiovocals.callback = function()
		{
			var vol:Float = 1;

			if (check_mute_kaiovocals.checked)
				vol = 0;

			kaiovocals.volume = vol;
		};

		var check_mute_godvocals = new FlxUICheckBox(140, 255, null, null, "Mute God Vocals", 100);
		check_mute_godvocals.checked = false;
		check_mute_godvocals.callback = function()
		{
			var vol:Float = 1;

			if (check_mute_godvocals.checked)
				vol = 0;

			godvocals.volume = vol;
		};

		var check_mute_blastervocals = new FlxUICheckBox(140, 310, null, null, "Mute Blaster Vocals", 100);
		check_mute_blastervocals.checked = false;
		check_mute_blastervocals.callback = function()
		{
			var vol:Float = 1;

			if (check_mute_blastervocals.checked)
				vol = 0;

			blastervocals.volume = vol;
		};
		...
		tab_group_song.add(check_mute_supervocals);
		tab_group_song.add(check_mute_kaiovocals);
		tab_group_song.add(check_mute_godvocals);
		tab_group_song.add(check_mute_blastervocals);
	...
	function loadSong(daSong:String):Void
	{
		...
		supervocals = new FlxSound().loadEmbedded(Paths.supervoices(daSong));
		kaiovocals = new FlxSound().loadEmbedded(Paths.kiovoices(daSong));
		godvocals = new FlxSound().loadEmbedded(Paths.eatervoices(daSong));
		blastervocals = new FlxSound().loadEmbedded(Paths.blastvoices(daSong));
		FlxG.sound.list.add(vocals);
		FlxG.sound.list.add(supervocals);
		FlxG.sound.list.add(kaiovocals);
		FlxG.sound.list.add(godvocals);
		FlxG.sound.list.add(blastervocals);
	...
	override function update(elapsed:Float)
	{
		...
		if (!typingShit.hasFocus)
		{
			...
			if (FlxG.mouse.wheel != 0)
			{
				...
				supervocals.time = FlxG.sound.music.time;
				kaiovocals.time = FlxG.sound.music.time;
				godvocals.time = FlxG.sound.music.time;
				blastervocals.time = FlxG.sound.music.time;
			}
