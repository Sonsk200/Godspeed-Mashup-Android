	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'shaggys': //this just copied cuz i can
			...
			case 'pshaggy':
				...
				playAnim('idle', true);
			case 'redpshaggy':
				tex = Paths.getSparrowAtlas('characters/redpshaggy', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'pshaggy_idle', 7, false);
				animation.addByPrefix('singUP', 'pshaggy_up', 28, false);
				animation.addByPrefix('singDOWN', 'pshaggy_down', 28, false);
				...
				playAnim('idle', true);
			case 'purplepshaggy':
				tex = Paths.getSparrowAtlas('characters/purplepshaggy', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'pshaggy_idle', 7, false);
				animation.addByPrefix('singUP', 'pshaggy_up', 28, false);
				animation.addByPrefix('singDOWN', 'pshaggy_down', 28, false);
				...
				playAnim('idle', true);
			case 'yellowpshaggy':
				tex = Paths.getSparrowAtlas('characters/yellowpshaggy', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'pshaggy_idle', 7, false);
				animation.addByPrefix('singUP', 'pshaggy_up', 28, false);
				animation.addByPrefix('singDOWN', 'pshaggy_down', 28, false);
			...
			case 'trickyMask':
				...
				addOffset("idle", 0, -35);
				addOffset("singUP", -27, -30);
				addOffset("singRIGHT", -4, -50);
				addOffset("singLEFT", -58, -28);
